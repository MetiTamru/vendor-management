...
let contracts: ContractModel[] = [
	{
		...
		executedOn: "2025-12-15",
		accountManager: "Dianna Coles",
		notes:
			"Primary supply agreement covering packaging SKUs A–D with annual rate review.",
		status: "active",
		value: 450000,
		currency: "USD",
		...
		rateSchedule: [
			{
				id: "rate-1a",
				serviceCode: "PKG-A",
				description: "Corrugated box – Size A",
				contractedRate: 1.25,
				unit: "Each",
			},
			{
				id: "rate-1b",
				serviceCode: "PKG-B",
				description: "Corrugated box – Size B",
				contractedRate: 1.85,
				unit: "Each",
			},
			{
				id: "rate-1c",
				serviceCode: "PKG-C",
				description: "Corrugated box – Size C",
				contractedRate: 2.4,
				unit: "Each",
			},
			{
				id: "rate-1d",
				serviceCode: "FRT-STD",
				description: "Standard freight surcharge",
				contractedRate: 45,
				unit: "Shipment",
			},
			{
				id: "rate-1e",
				serviceCode: "LAB-1",
				description: "Custom labeling fee",
				contractedRate: 0.12,
				unit: "Unit",
			},
		],
		...
		documents: [
			{
				id: "doc-1a",
				name: "Executed Master Agreement.pdf",
				type: "Contract",
			...
			{
				id: "doc-1b",
				name: "Rate Schedule Exhibit A.xlsx",
				type: "Exhibit",
				uploadedOn: "2025-12-16",
				fileExtension: "xlsx",
			},
			{
				id: "doc-1c",
	...
	},
	{
		...
		contractType: "MSA",
		paymentModel: "Fixed Fee + Usage",
		paymentTerms: "Net 45",
		governingLaw: "State of California",
		executedOn: null,
		accountManager: "Marcus Webb",
		notes: "Pending legal review of RMA and warranty clauses.",
		...
		rateSchedule: [
			{
				id: "rate-2a",
				serviceCode: "HW-LAP",
				description: "Business laptop – standard config",
				contractedRate: 980,
				unit: "Unit",
			},
			{
			...
			},
			{
				id: "rate-2c",
				serviceCode: "SVC-RMA",
				description: "Next-business-day RMA handling",
				contractedRate: 35,
				unit: "Incident",
			},
		],
		...
		documents: [
			...
			{
				id: "doc-2b",
				name: "Hardware Catalog Pricing.pdf",
				type: "Exhibit",
	...
	},
	{
		id: "ctr-3",
		number: "HZN-2026-008",
		title: "Regional Freight Master Services Agreement",
		vendorId: "vnd-2",
		vendorName: "Horizon Logistics Co.",
		vendorType: "Logistics",
		contractType: "MSA",
		paymentModel: "Usage-based",
		paymentTerms: "Net 15",
		governingLaw: "Federal Democratic Republic of Ethiopia",
		executedOn: "2025-11-01",
		accountManager: "Sara Bekele",
		notes:
			"Covers regional freight and last-mile delivery for East Africa corridors.",
		status: "active",
		value: 320000,
		currency: "USD",
		startDate: "2026-01-01",
		endDate: daysFromNow(55),
		slaSummary: "On-time delivery ≥ 96% · POD within 24h",
		updatedAt: now(),
		terms: [
			{
				id: "term-3a",
		...
		rateSchedule: [
			{
				id: "rate-3a",
				serviceCode: "FRT-REG",
				description: "Regional linehaul – per km",
				contractedRate: 1.15,
				unit: "Km",
			},
			{
			...
			{
				id: "rate-3c",
				serviceCode: "FRT-FUEL",
				description: "Fuel surcharge",
				contractedRate: 0.08,
				unit: "Percent of base",
			},
		],
		slaMetrics: [
			{
		...
		documents: [
			{
				id: "doc-3a",
				name: "Freight MSA.pdf",
				type: "Contract",
				uploadedOn: "2025-11-01",
				fileExtension: "pdf",
			},
			{
				id: "doc-3b",
				name: "Lane Rate Card.xlsx",
				type: "Exhibit",
	...
	},
	{
		...
		vendorId: "vnd-1",
		vendorName: "ABC Healthcare Network",
		vendorType: "Provider",
		contractType: "Standard",
		paymentModel: "Contracted Rate",
		paymentTerms: "Net 30",
		...
		accountManager: "Dianna Coles",
		notes:
			"Network participation covering professional and facility services in Region East.",
		status: "active",
		value: 2500000,
		currency: "USD",
		startDate: "2026-01-01",
		endDate: "2027-12-31",
		slaSummary: "Claim acceptance ≥ 95% · Timely filing 90 days",
		updatedAt: now(),
		terms: [
			{
				id: "term-4a",
		...
		rateSchedule: [
			...
			},
			{
				id: "rate-4b",
				serviceCode: "99214",
				description: "Office/outpatient visit, moderate",
				contractedRate: 135,
				unit: "Encounter",
			},
			{
		...
		slaMetrics: [
			...
			{
				id: "sla-4b",
				name: "Timely Filing Compliance",
				target: "≤ 90 days",
				tone: "sky",
			},
			{
				id: "sla-4c",
				name: "Prior Auth Turnaround",
				target: "≤ 72 hours",
				tone: "violet",
			},
			{
				id: "sla-4d",
				name: "Provider Directory Accuracy",
				target: "≥ 98%",
				tone: "amber",
			},
		],
		documents: [
			{
				id: "doc-4a",
				name: "Network Participation Agreement.pdf",
				type: "Contract",
				uploadedOn: "2025-12-15",
				fileExtension: "pdf",
			},
	...
	{
		id: "ctr-5",
		number: "CTR-2026-0020",
		title: "Organic Produce Supply Agreement",
		vendorId: "vnd-4",
		vendorName: "GreenField Organics PLC",
		vendorType: "Supplier",
		...
		governingLaw: "Federal Democratic Republic of Ethiopia",
		executedOn: null,
		accountManager: "Meron Tadesse",
		notes: "Draft pending quality certification review.",
		status: "draft",
		value: 85000,
		currency: "ETB",
		startDate: "2026-09-01",
		endDate: "2027-08-31",
		slaSummary: "Cold-chain unbroken · Fill rate ≥ 97%",
		updatedAt: now(),
		terms: [
			{
				id: "term-5a",
		...
		documents: [
			{
				id: "doc-5a",
				name: "Draft Supply Agreement.docx",
				type: "Contract",
	...
	{
		id: "ctr-6",
		number: "CTR-2024-0099",
		title: "Legacy Packaging Spot Buy",
		vendorId: "vnd-1",
		vendorName: "Apex Industrial Supply LLC",
		vendorType: "Provider",
		contractType: "SOW",
		...
		executedOn: "2024-01-15",
		accountManager: "Jordan Lee",
		notes: "Expired — superseded by CTR-2025-0042.",
		status: "expired",
		value: 60000,
		currency: "USD",
		startDate: "2024-02-01",
		endDate: "2025-01-31",
		slaSummary: "Standard delivery",
		updatedAt: now(),
		terms: [
			{
				id: "term-6a",
		...
		rateSchedule: [
			{
				id: "rate-6a",
				serviceCode: "PKG-SPOT",
				description: "Spot packaging lot",
				contractedRate: 2200,
				unit: "Lot",
			},
		],
	...
	{
		id: "ctr-7",
		number: "CTR-2025-0077",
		title: "Temporary Component Bridge Agreement",
		vendorId: "vnd-3",
		vendorName: "NovaTech Components Inc.",
		vendorType: "Technology",
		contractType: "SOW",
		...
		accountManager: "Marcus Webb",
		notes: "Terminated early due to component end-of-life.",
		status: "terminated",
		value: 45000,
		currency: "EUR",
