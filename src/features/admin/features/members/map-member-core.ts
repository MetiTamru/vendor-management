...
export function memberListDtoToSummary(row: MemberListDto): MemberSummary {
	return {
		...
		eligibilityLabel: mapEligibilityLabel(row.eligibility_label),
