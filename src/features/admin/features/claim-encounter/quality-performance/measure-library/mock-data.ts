...
export const MEASURE_LIBRARY_FILTERS = {
	measurementYears: ["MY 2025 (Jan 1 - Dec 31, 2025)", "MY 2024 (Jan 1 - Dec 31, 2024)"],
...
export const CBP_MEASURE_DETAIL: MeasureDetail = {
		...
		relatedMeasures: [
			...
			{ id: "A1C", name: "Diabetes: HbA1c Poor Control", relationship: "Related Condition" },
			{ id: "PPC", name: "Prenatal and Postpartum Care", relationship: "Complementary" },
			{ id: "WCC", name: "Weight Assessment and Counseling", relationship: "Related" },
			{ id: "HBD", name: "Hemoglobin A1c Control", relationship: "Related Condition" },
		],
		documents: [
			{ id: "d1", name: "CBP Measure Specifications MY 2025", type: "Specifications", updated: "Jul 15, 2025" },
			{ id: "d2", name: "CBP Technical Notes", type: "Technical Notes", updated: "Jun 1, 2025" },
			{ id: "d3", name: "CBP Provider Tips", type: "Provider Tips", updated: "May 15, 2025" },
		],
	notes:
...
export const CBP_SPECIFICATIONS: MeasureSpecifications = {
	...
	valueSets: [
		{ type: "Diagnosis (ICD-10)", codeSetName: "Hypertension (HTN)", version: "v2025" },
		{ type: "Procedure (CPT)", codeSetName: "Blood Pressure Measurement", version: "v2025" },
...
export const CBP_ELIGIBLE_POPULATION: MeasureEligiblePopulationDetail = {
	...
	lookBackPeriod: "None",
	ageCalculation: "Age is calculated as of December 31 of the measurement year.",
	...
	trend: [
		{ month: "Jan 2025", commercial: 12_102, medicaid: 7_612, medicare: 4_118, total: 23_832 },
		{ month: "Feb 2025", commercial: 12_186, medicaid: 7_658, medicare: 4_142, total: 23_986 },
		{ month: "Mar 2025", commercial: 12_248, medicaid: 7_702, medicare: 4_168, total: 24_118 },
		{ month: "Apr 2025", commercial: 12_312, medicaid: 7_748, medicare: 4_198, total: 24_258 },
		{ month: "May 2025", commercial: 12_384, medicaid: 7_792, medicare: 4_228, total: 24_404 },
		{ month: "Jun 2025", commercial: 12_458, medicaid: 7_842, medicare: 4_262, total: 24_562 },
	],
	plans: [
		{
			id: "PLAN-001",
...
export const CBP_DENOMINATOR: MeasureDenominatorDetail = {
	...
	trend: [
		{ month: "Jan 2025", commercial: 9_412, medicaid: 5_668, medicare: 3_570, total: 18_650 },
		{ month: "Feb 2025", commercial: 9_478, medicaid: 5_712, medicare: 3_590, total: 18_780 },
		{ month: "Mar 2025", commercial: 9_532, medicaid: 5_748, medicare: 3_610, total: 18_890 },
		{ month: "Apr 2025", commercial: 9_578, medicaid: 5_772, medicare: 3_630, total: 18_980 },
		{ month: "May 2025", commercial: 9_612, medicaid: 5_792, medicare: 3_646, total: 19_050 },
		{ month: "Jun 2025", commercial: 9_642, medicaid: 5_812, medicare: 3_658, total: 19_112 },
	],
	plans: [
		{
			id: "PLAN-001",
...
export const CBP_NUMERATOR: MeasureNumeratorDetail = {
	...
	trend: [
		{ month: "Jan 2025", commercial: 7_318, medicaid: 4_308, medicare: 2_248, total: 14_512 },
		{ month: "Feb 2025", commercial: 7_372, medicaid: 4_348, medicare: 2_264, total: 14_584 },
		{ month: "Mar 2025", commercial: 7_418, medicaid: 4_382, medicare: 2_278, total: 14_652 },
		{ month: "Apr 2025", commercial: 7_462, medicaid: 4_412, medicare: 2_292, total: 14_718 },
		{ month: "May 2025", commercial: 7_698, medicaid: 4_538, medicare: 2_358, total: 14_794 },
		{ month: "Jun 2025", commercial: 7_842, medicaid: 4_620, medicare: 2_407, total: 14_869 },
	],
	plans: [
		{
			id: "PLAN-001",
...
export function getMeasureSpecifications(measureId: string): MeasureSpecifications {
	if (measureId === "CBP") return CBP_SPECIFICATIONS;

	const detail = getMeasureDetail(measureId);
	return {
		...CBP_SPECIFICATIONS,
		measureDescription: detail?.description ?? CBP_SPECIFICATIONS.measureDescription,
		eligiblePopulation: detail?.eligiblePopulation ?? CBP_SPECIFICATIONS.eligiblePopulation,
		...
		collectionMethod: detail?.collectionMethod ?? CBP_SPECIFICATIONS.collectionMethod,
		calculationMethod: detail?.calculationMethod ?? CBP_SPECIFICATIONS.calculationMethod,
		inverseMeasure: detail?.inverseMeasure ?? CBP_SPECIFICATIONS.inverseMeasure,
		higherRateIsBetter: detail?.higherRateIsBetter ?? CBP_SPECIFICATIONS.higherRateIsBetter,
...
export function getMeasureEligiblePopulation(
	...
	return {
		...
		definition: detail?.eligiblePopulation ?? CBP_ELIGIBLE_POPULATION.definition,
		summary: {
...
export function getMeasureDenominator(measureId: string): MeasureDenominatorDetail {
...
export const CBP_EXCLUSIONS: MeasureExclusionsDetail = {
	...
	byReason: [
		{ reason: "Hospice (Anytime)", commercial: 142, medicaid: 98, medicare: 42, total: 282, pctOfTotal: 23.44 },
		{ reason: "Hospice Election", commercial: 86, medicaid: 62, medicare: 28, total: 176, pctOfTotal: 14.63 },
		{ reason: "Death", commercial: 124, medicaid: 88, medicare: 36, total: 248, pctOfTotal: 20.62 },
		{ reason: "Not Continuously Enrolled (11 Months)", commercial: 98, medicaid: 72, medicare: 24, total: 194, pctOfTotal: 16.13 },
		{ reason: "End-Stage Renal Disease (ESRD)", commercial: 52, medicaid: 38, medicare: 18, total: 108, pctOfTotal: 8.98 },
		{ reason: "Pregnancy", commercial: 68, medicaid: 34, medicare: 12, total: 114, pctOfTotal: 9.48 },
		{ reason: "Age 66+ as of Dec 31", commercial: 42, medicaid: 20, medicare: 19, total: 81, pctOfTotal: 6.73 },
	],
	plans: [
		{
			id: "PLAN-001",
...
export const CBP_PERFORMANCE: MeasurePerformanceDetail = {
	...
	byPopulationGroup: [
		{ group: "Age 18-34", numerator: 842, denominator: 1_210, rate: 69.57, priorYearRate: 68.12, change: 1.45 },
		{ group: "Age 35-44", numerator: 1_624, denominator: 2_030, rate: 80.02, priorYearRate: 78.45, change: 1.57 },
		{ group: "Age 45-54", numerator: 2_486, denominator: 3_162, rate: 78.67, priorYearRate: 76.68, change: 1.99 },
		{ group: "Age 55-64", numerator: 3_842, denominator: 4_772, rate: 80.48, priorYearRate: 79.12, change: 1.36 },
		{ group: "Age 65-85", numerator: 6_075, denominator: 7_968, rate: 76.24, priorYearRate: 74.31, change: 1.93 },
	],
	historicalTrend: [
		{ year: "MY 2021", numerator: 11_842, denominator: 16_604, exclusions: 982, performanceRate: 71.33 },
		{ year: "MY 2022", numerator: 12_486, denominator: 17_218, exclusions: 1_024, performanceRate: 72.52 },
		{ year: "MY 2023", numerator: 13_218, denominator: 17_892, exclusions: 1_086, performanceRate: 73.88 },
		{ year: "MY 2024", numerator: 13_842, denominator: 18_524, exclusions: 1_148, performanceRate: 76.35 },
		{ year: "MY 2025", numerator: 14_869, denominator: 19_112, exclusions: 1_203, performanceRate: 77.81 },
	],
	notes: [
...
export function getMeasureExclusions(measureId: string): MeasureExclusionsDetail {
...
export function getMeasurePerformance(measureId: string): MeasurePerformanceDetail {
	...
	return {
		...
		trend: CBP_PERFORMANCE.trend.map((row, index) => ({
			...row,
			rate: Math.round((rate - (CBP_PERFORMANCE.trend.length - 1 - index) * 0.6) * 100) / 100,
		})),
	};
}
...
export const CBP_MEMBERS: MeasureMembersDetail = {
	...
	byStatus: [
		{ name: "Met Measure (Numerator)", value: 14_869, pct: 77.8, color: "#22c55e" },
	...
	byPlan: [
		{ planName: "Commercial PPO", denominator: 3_624, numerator: 2_839, rate: 78.35 },
		{ planName: "HMO Silver", denominator: 2_872, numerator: 2_218, rate: 77.21 },
		{ planName: "Medicaid Managed Care", denominator: 5_288, numerator: 3_968, rate: 75.03 },
		{ planName: "Medicare Advantage HMO", denominator: 2_168, numerator: 1_684, rate: 77.61 },
		{ planName: "Dual Eligible SNP", denominator: 1_212, numerator: 892, rate: 73.55 },
		{ planName: "Medicare Advantage PPO", denominator: 0, numerator: 0, rate: null },
	],
	members: [
		{
			id: "MBR-2025-88421",
	...
	totalMembers: 19_112,
	filterOptions: {
		plans: ["All", "Commercial PPO", "HMO Silver", "Medicaid Managed Care", "Medicare Advantage HMO"],
		linesOfBusiness: ["All", "Commercial", "Medicaid", "Medicare"],
		statuses: ["All", "Met Measure", "Not Met", "Excluded", "Pending"],
		providers: ["All", "Smith, John MD", "Johnson, Sarah MD", "Chen, Lisa MD", "Martinez, Carlos MD"],
		riskGroups: ["All", "Low", "Medium", "High"],
		lastOutreach: ["All", "Last 30 Days", "Last 90 Days", "Over 90 Days", "Never"],
	},
};
...
export const CBP_PROVIDERS: MeasureProvidersDetail = {
	...
	filterOptions: {
		...
		specialties: ["All", "Internal Medicine", "Family Practice", "Cardiology", "Multi-Specialty"],
		riskGroups: ["All", "Low", "Medium", "High"],
		performanceLevels: ["All", "High", "Above Average", "Average", "Below Average", "Low"],
	},
};
...
export const CBP_GAP_CLOSURE: MeasureGapClosureDetail = {
	...
	byStatus: [
		...
		{ name: "Open - Not Contacted", value: 1_997, pct: 47.06, color: "#94a3b8" },
		{ name: "Overdue", value: 1_152, pct: 27.02, color: "#ef4444" },
	],
	byReason: [
		{ reason: "No BP Reading", totalGaps: 1_842, closedGaps: 412, closureRate: 22.37 },
		{ reason: "BP Reading >= 140/90", totalGaps: 1_486, closedGaps: 328, closureRate: 22.07 },
		{ reason: "Medication Adherence", totalGaps: 624, closedGaps: 142, closureRate: 22.76 },
		{ reason: "Follow-Up Needed", totalGaps: 198, closedGaps: 48, closureRate: 24.24 },
	...
	goal: 30,
	gaps: [
		{ memberId: "MBR-2025-77204", memberName: "Maria Garcia", dob: "11/22/1975", planName: "HMO Silver", gapReason: "BP Reading >= 140/90", dateIdentified: "03/15/2025", status: "In Process", outreachDate: "06/20/2025", lastAction: "Outbound call completed", assignedTo: "Care Manager A" },
		{ memberId: "MBR-2025-55892", memberName: "Patricia Brown", dob: "01/30/1982", planName: "Medicaid Managed Care", gapReason: "No BP Reading", dateIdentified: "02/08/2025", status: "Closed", outreachDate: "06/25/2025", lastAction: "BP reading documented", assignedTo: "Care Manager B" },
		{ memberId: "MBR-2025-10742", memberName: "Jennifer Taylor", dob: "08/11/1988", planName: "Commercial PPO", gapReason: "Follow-Up Needed", dateIdentified: "04/22/2025", status: "Open - Not Contacted", outreachDate: "—", lastAction: "—", assignedTo: "Outreach Team" },
		{ memberId: "MBR-2025-44107", memberName: "James Davis", dob: "09/14/1960", planName: "Commercial PPO", gapReason: "Medication Adherence", dateIdentified: "01/18/2025", status: "Overdue", outreachDate: "05/10/2025", lastAction: "Letter sent", assignedTo: "Care Manager A" },
		{ memberId: "MBR-2025-99631", memberName: "David Anderson", dob: "02/28/1963", planName: "Medicare Advantage HMO", gapReason: "No BP Reading", dateIdentified: "05/05/2025", status: "In Process", outreachDate: "07/01/2025", lastAction: "Appointment scheduled", assignedTo: "Care Manager C" },
		{ memberId: "MBR-2025-88520", memberName: "Susan Thomas", dob: "06/17/1978", planName: "Medicaid Managed Care", gapReason: "BP Reading >= 140/90", dateIdentified: "03/28/2025", status: "Closed", outreachDate: "06/18/2025", lastAction: "Gap closed - BP controlled", assignedTo: "Care Manager B" },
		{ memberId: "MBR-2025-66118", memberName: "Robert Williams", dob: "07/08/1955", planName: "Medicare Advantage HMO", gapReason: "Other", dateIdentified: "06/01/2025", status: "Open - Not Contacted", outreachDate: "—", lastAction: "—", assignedTo: "Outreach Team" },
		{ memberId: "MBR-2025-32984", memberName: "Linda Miller", dob: "12/05/1948", planName: "Dual Eligible SNP", gapReason: "Follow-Up Needed", dateIdentified: "04/10/2025", status: "Overdue", outreachDate: "05/22/2025", lastAction: "Member unreachable", assignedTo: "Care Manager C" },
		{ memberId: "MBR-2025-21856", memberName: "Michael Wilson", dob: "04/20/1970", planName: "HMO Silver", gapReason: "No BP Reading", dateIdentified: "02/14/2025", status: "In Process", outreachDate: "06/28/2025", lastAction: "Provider notified", assignedTo: "Care Manager A" },
		{ memberId: "MBR-2025-88421", memberName: "John Smith", dob: "03/15/1968", planName: "Commercial PPO", gapReason: "Medication Adherence", dateIdentified: "05/18/2025", status: "Closed", outreachDate: "07/05/2025", lastAction: "Pharmacy refill confirmed", assignedTo: "Clinical Staff" },
	],
	byPlan: [
		{ planName: "Commercial PPO", totalGaps: 892, closedGaps: 198, closureRate: 22.2 },
		{ planName: "HMO Silver", totalGaps: 624, closedGaps: 142, closureRate: 22.76 },
		{ planName: "Medicaid Managed Care", totalGaps: 1_486, closedGaps: 328, closureRate: 22.07 },
		{ planName: "Medicare Advantage HMO", totalGaps: 748, closedGaps: 168, closureRate: 22.46 },
		{ planName: "Dual Eligible SNP", totalGaps: 312, closedGaps: 68, closureRate: 21.79 },
	],
	recentActivities: [
		{ id: "a1", type: "closed", message: "Gap closed for MBR-2025-55892", timestamp: "Jul 30, 2025 02:10 PM" },
		{ id: "a2", type: "call", message: "Outbound call completed for MBR-2025-77204", timestamp: "Jul 30, 2025 01:45 PM" },
		{ id: "a3", type: "letter", message: "Letter sent to MBR-2025-44107", timestamp: "Jul 29, 2025 04:30 PM" },
		{ id: "a4", type: "overdue", message: "Gap overdue for MBR-2025-32984", timestamp: "Jul 29, 2025 09:15 AM" },
		{ id: "a5", type: "closed", message: "Gap closed for MBR-2025-88520", timestamp: "Jul 28, 2025 03:20 PM" },
	],
	totalGaps: 4_243,
	filterOptions: {
		plans: ["All", "Commercial PPO", "HMO Silver", "Medicaid Managed Care", "Medicare Advantage HMO"],
		linesOfBusiness: ["All", "Commercial", "Medicaid", "Medicare"],
		statuses: ["All", "In Process", "Closed", "Open - Not Contacted", "Overdue"],
		reasons: ["All", "No BP Reading", "BP Reading >= 140/90", "Medication Adherence", "Follow-Up Needed", "Other"],
		riskGroups: ["All", "Low", "Medium", "High"],
	},
};
...
export const CBP_MEASURE_DOCUMENTS: MeasureDocumentsDetail = {
	...
	documents: [
		{ id: "d1", name: "CBP Measure Specifications MY 2025", type: "PDF", category: "Specifications", version: "v2025.1", size: "4.2 MB", updated: "Jul 15, 2025", updatedBy: "Quality Analyst", status: "Current" },
		{ id: "d2", name: "CBP Technical Notes", type: "PDF", category: "Technical Notes", version: "v2025.1", size: "1.8 MB", updated: "Jun 1, 2025", updatedBy: "Quality Team", status: "Current" },
		{ id: "d3", name: "CBP Provider Tips", type: "PDF", category: "Provider Tips", version: "v2025", size: "980 KB", updated: "May 15, 2025", updatedBy: "Clinical Team", status: "Current" },
		{ id: "d4", name: "HEDIS 2025 Volume 2 - CBP", type: "PDF", category: "Specifications", version: "NCQA 2025", size: "2.4 MB", updated: "Jan 10, 2025", updatedBy: "NCQA", status: "Reference" },
		{ id: "d5", name: "CBP Value Set Reference", type: "XLSX", category: "Technical Notes", version: "v2025.2", size: "856 KB", updated: "Jul 1, 2025", updatedBy: "Data Team", status: "Current" },
		{ id: "d6", name: "MY 2025 Gap Closure Report - Jun", type: "PDF", category: "Reports", version: "Jun 2025", size: "1.2 MB", updated: "Jul 5, 2025", updatedBy: "System", status: "Current" },
		{ id: "d7", name: "CBP NCQA Submission File", type: "XML", category: "Submission Files", version: "MY 2025", size: "12.4 MB", updated: "Jul 28, 2025", updatedBy: "Submission Team", status: "Submitted" },
		{ id: "d8", name: "CBP Audit Workpapers", type: "PDF", category: "Audit", version: "Q2 2025", size: "3.6 MB", updated: "Jul 20, 2025", updatedBy: "Audit Team", status: "Current" },
		{ id: "d9", name: "Provider Performance Summary", type: "XLSX", category: "Reports", version: "Jul 2025", size: "2.1 MB", updated: "Jul 30, 2025", updatedBy: "Analytics", status: "Current" },
		{ id: "d10", name: "CBP Member Outreach Scripts", type: "DOCX", category: "Provider Tips", version: "v3", size: "420 KB", updated: "Apr 12, 2025", updatedBy: "Outreach Team", status: "Current" },
	],
	filterOptions: {
		categories: ["All", "Specifications", "Technical Notes", "Provider Tips", "Reports", "Submission Files", "Audit"],
...
export const CBP_MEASURE_HISTORY: MeasureHistoryDetail = {
	filterOptions: {
		historyViews: ["Performance History", "Specification History", "Population History", "All Changes"],
	...
	changeHistory: [
		{ id: "c1", dateTime: "Jul 30, 2025 02:15 PM", changeType: "Performance Refresh", changeTypeStyle: "border-violet-200 bg-violet-50 text-violet-800", section: "Performance", changedBy: "System", description: "Monthly performance recalculation completed", impact: "Low", impactStyle: "border-emerald-200 bg-emerald-50 text-emerald-800" },
		{ id: "c2", dateTime: "Jul 15, 2025 10:30 AM", changeType: "Specification Update", changeTypeStyle: "border-sky-200 bg-sky-50 text-sky-800", section: "Specifications", changedBy: "Quality Analyst", description: "Updated denominator criteria for MY 2025", impact: "High", impactStyle: "border-red-200 bg-red-50 text-red-800" },
		{ id: "c3", dateTime: "Jul 10, 2025 03:45 PM", changeType: "Population Update", changeTypeStyle: "border-emerald-200 bg-emerald-50 text-emerald-800", section: "Eligible Population", changedBy: "Data Team", description: "Refreshed eligible population counts", impact: "Medium", impactStyle: "border-amber-200 bg-amber-50 text-amber-800" },
		{ id: "c4", dateTime: "Jun 28, 2025 11:20 AM", changeType: "Exclusion Update", changeTypeStyle: "border-amber-200 bg-amber-50 text-amber-800", section: "Exclusions", changedBy: "Quality Analyst", description: "Added new exclusion for ESRD", impact: "Medium", impactStyle: "border-amber-200 bg-amber-50 text-amber-800" },
		{ id: "c5", dateTime: "Jun 15, 2025 09:00 AM", changeType: "Performance Refresh", changeTypeStyle: "border-violet-200 bg-violet-50 text-violet-800", section: "Performance", changedBy: "System", description: "Corrected BP reading mapping", impact: "High", impactStyle: "border-red-200 bg-red-50 text-red-800" },
		{ id: "c6", dateTime: "May 20, 2025 02:30 PM", changeType: "Numerator Update", changeTypeStyle: "border-sky-200 bg-sky-50 text-sky-800", section: "Numerator", changedBy: "Clinical Team", description: "Updated numerator logic for telehealth visits", impact: "Low", impactStyle: "border-emerald-200 bg-emerald-50 text-emerald-800" },
	],
	yearOverYear: [
		{ year: "MY 2021", eligiblePopulation: 21_842, denominator: 16_604, numerator: 11_842, exclusions: 982, performanceRate: 71.33, goal: 80.0, variance: -8.67, status: "Not Met", changeFromPriorYear: null },
		{ year: "MY 2022", eligiblePopulation: 22_486, denominator: 17_218, numerator: 12_486, exclusions: 1_024, performanceRate: 72.76, goal: 80.0, variance: -7.24, status: "Not Met", changeFromPriorYear: 1.43 },
		{ year: "MY 2023", eligiblePopulation: 23_118, denominator: 17_892, numerator: 13_218, exclusions: 1_086, performanceRate: 72.74, goal: 80.0, variance: -7.26, status: "Not Met", changeFromPriorYear: -0.02 },
		{ year: "MY 2024", eligiblePopulation: 23_842, denominator: 18_524, numerator: 13_842, exclusions: 1_148, performanceRate: 76.35, goal: 80.0, variance: -3.65, status: "Not Met", changeFromPriorYear: 3.61 },
		{ year: "MY 2025", eligiblePopulation: 24_562, denominator: 19_112, numerator: 14_869, exclusions: 1_203, performanceRate: 77.81, goal: 80.0, variance: -2.19, status: "Not Met", changeFromPriorYear: 1.46 },
	],
	totalChangeEntries: 48,
};

export function getMeasureGapClosure(measureId: string): MeasureGapClosureDetail {
	...
	return {
		...CBP_GAP_CLOSURE,
		summary: { ...CBP_GAP_CLOSURE.summary, openGaps, closedGaps, totalGaps: openGaps + closedGaps },
