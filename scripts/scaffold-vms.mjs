#!/usr/bin/env node
/**
 * Generates VMS feature scaffolding. Run once from repo root:
 *   node scripts/scaffold-vms.mjs
 */
...
// ── Shared mock store ──────────────────────────────────────────────
write(
	"src/features/shared/vms/mock-store.ts",
	`import type {
...
let categories: VendorCategoryModel[] = [
	{
		id: "cat-1",
		name: "Raw Materials",
		code: "RAW",
...
let activities: ActivityEventModel[] = [
	{
		id: "act-1",
		vendorId: "vnd-3",
...
let teamMembers: VendorTeamMember[] = [
	{
		id: "tm-1",
		name: "Jordan Lee",
		email: "jordan@apex-supply.example",
...
console.log("mock-store written");
